 ...
 * Deal_List.java
 *
 * Created on March 5, 2009, 12:03 AM
 */
 ...
 * @author  student
 */
public class Deal_List extends javax.swing.JInternalFrame {
    javax.swing.JDesktopPane jdpt;
    ResultSet rs;
    int table;
    Database db;
    Mod m;
    /** Creates new form Deal_List */
    public Deal_List(String title,
                      boolean resizable,
                      boolean closable,
                      boolean maximizable,
                      boolean iconifiable,javax.swing.JDesktopPane jdp){
        super(title,false,true,false,true);
        setTitle(" Deal's List ");
         jdpt=jdp;
        db = new Database();
        rs = db.cdList("Deal");
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        try{
            if(!record.getText().equals(null)) {
                ...
                Deal_iView mf = new Deal_iView(this,id);
                jdpt.add( mf );
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try{
            if(!record.getText().equals(null)) {
                ...
                Deal_iEdit mf = new Deal_iEdit(this,id);
                jdpt.add( mf );
                mf.setVisible(true);// attach internal frame
